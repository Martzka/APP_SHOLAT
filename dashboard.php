...
<head>
  ...
  <style>
    body {
      background-image: url('https://i.pinimg.com/736x/f0/eb/b0/f0ebb045849748b3c545a7a77493ba7e.jpg');
...
<body>
      ...
      <div class="col-md-8">
        <div class="card border-0 shadow rounded">
          <div class="card-header mb-3">
            <strong>Aplikasi Ibadah - Pencatatan 11 RPL Sholat</strong>
          </div>
            ...
            <div class="card-body">
              ...
              <table class="table" id="tabelData">
                ...
                <tbody id="tabelBody">
                  <tr>
                    <td>
                      <input type="datetime-local" class="form-control" id="birthdaytime" name="Tanggal sholat">
                    </td>
                    <td>
                      <select class="form-control pilihan" name="Sholat">
                        <option value="">Pilih</option>
                        <option value="Sholat Zuhur">Sholat Zuhur</option>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                        <input type="checkbox" class="btn-check" name="status" value="Terlambat" id="btncheck1"
                          autocomplete="off" checked>
                    <td>
                      <input id="keterangan-sholat" type="text" name="keterangan" class="form-control"
                        placeholder="Keterangan">
                    </td>
            </div>
            </td>
            <td>
              <a href="" id="remove-button" class="btn btn-danger btn-remove"><span
                  class="badge rounded-pill text-bg-danger"><i class="bi bi-trash-fill"></i></span></a>
            </td>
            </tr>
  ...
  <script>
    const scriptURL = 'https://script.google.com/macros/s/AKfycbyfr_8J_NevlVGX3xTqr1xX0neqkrFwKYj3rKqx3d02T6uHvHnU_MjMVtRDy5P53by_/exec'
  ...
  <script>
    document.getElementById('tambahBaris').addEventListener('click', function () {
      ...
      newRow.innerHTML = `
        ...
        <td>
          <select class="form-control" id="pilihan" name="Sholat_${rowCount}">
          <option value="">Pilih</option>
          <option value="Sholat Zuhur">Sholat Zuhur</option>
          <option value="Sholat Ashar">Sholat Ashar</option>
          <option value="Tidak Sholat">Tidak Sholat</option>
        ...
        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
               <input type="checkbox" class="btn-check" name="status" value="Terlambat" id="btncheck1" autocomplete="off" checked>
                 <td>                   
                    <input id="keterangan-sholat" type="text" name="keterangan" class="form-control" placeholder="Keterangan">
                 </td>
          </div>
        </td>
        <td>
