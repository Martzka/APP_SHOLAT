...
<head>
    ...
    <style>
        body {
            background-image: url('https://i.pinimg.com/564x/7b/a6/f2/7ba6f2ce9a07d38dc17dd40b232689ac.jpg');
                        ...
                        <div div class="row">
                            <form action="actionLogin.php" method="post" id="loginForm">
                                ...
                                <a href="#" class="btn btn-outline-secondary mt-3"
                                    onclick="switchForms('registerForm')">Register</a>
                            </form>
                            <form action="registrasi.php" method="post" id="registerForm" style="display: none;">
                                <div class="card-header mb-3">
                                    <strong>Registrasi Akun Baru</strong>
                                </div>
                                <input class="form-control" type="text" id="regUsername" name="reg_username"
                                    placeholder="Username register" autofocus autocomplete="off">
                                <input class="form-control mt-3" type="password" id="regPassword" name="reg_password"
                                    placeholder="Password register" autofocus autocomplete="off">
                                <button type="submit" class="btn btn-primary mt-3"
                                    onclick="showAlert()">Register</button>
                                <a href="#" class="btn btn-outline-danger mt-3"
                                    onclick="switchForms('loginForm')">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
